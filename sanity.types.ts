...
export type BentoCard = {
  _type: "bento-card";
  icon?: "Building2" | "Landmark" | "Grid3x3" | "Compass" | "Home" | "Target";
  title?: string;
  description?: string;
  image?: {
    asset?: {
...
export type GalleryLightbox = {
  ...
  images?: Array<{
    ...
    tags?: Array<{
      ...
      _weak?: boolean;
      _key: string;
      [internalGroqTypeReferenceTo]?: "gallery-tag";
    }>;
    hasVideo?: boolean;
    video?: VideoField;
    _type: "galleryItem";
...
export type AllSanitySchemaTypes = BentoCard | BentoBox | ContactInfo | ContentBlock | Team1 | FeaturesCard | FeaturesCards | GalleryLightbox | FeaturedProjects | AllPosts | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timeline2 | Timelines1 | TimelineRow | CarouselGalleryItem | CarouselGallery | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitProject | SplitOffering | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | Hero3 | Hero2 | Hero1 | SocialLink | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Settings | Navigation | Testimonial | Faq | GalleryTag | Category | BlogPage | ProjectsPage | Project | Page | VideoField | Post | Author | LucideIcon | MediaTag | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Source: ./sanity/queries/industry.ts
// Variable: INDUSTRY_QUERY
// Query: *[_type == "industry" && slug.current == $slug][0]{  _id,  title,  slug,  description,  image{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _createdAt,  _updatedAt,  meta_title,  meta_description,  noindex,  ogImage {    asset->{      _id,      url,      metadata {        dimensions {          width,          height        }      }    },  }}
export type INDUSTRY_QUERYResult = null;
// Variable: INDUSTRIES_QUERY
// Query: *[_type == "industry" && defined(slug)] | order(orderRank){  title,  slug,  description,  image{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },}
export type INDUSTRIES_QUERYResult = Array<never>;
// Variable: INDUSTRIES_SLUGS_QUERY
// Query: *[_type == "industry" && defined(slug)]{slug}
export type INDUSTRIES_SLUGS_QUERYResult = Array<never>;

// Source: ./sanity/queries/navigation.ts
// Variable: NAVIGATION_QUERY
// Query: *[_type == "navigation"]{    _type,    _key,    links[]{      _key,      _type,      title,      hasSubmenu,      buttonVariant,      target,          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    ),      subItems[]{        _key,        title,        description,        icon,        isExternal,        target,            _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )      }    }  }
export type NAVIGATION_QUERYResult = Array<{
  ...
  links: Array<{
    ...
    href: string | "/" | "/blog" | "/projects" | null;
    subItems: Array<{
      _key: string;
      title?: string;
      description?: string;
...
// Source: ./sanity/queries/offering.ts
// Variable: OFFERING_QUERY
// Query: *[_type == "offering" && slug.current == $slug][0]{  companyName,  slug,  logo{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  tagline,  backgroundImage{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  industries[]->{    title,    slug,  },  description,  leadershipBios[]{    _key,    name,    role,    biography,    photo{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    }  },  missionStatement,  geography,  valuation,  regulationType,  projectedReturns,  minimumInvestment,  status,  investorDocuments[]{    _key,    title,    description,    asset->{      _id,      url,      originalFilename,      extension,      size    }  },  tokenStructure,  blockchainStandard,  custodianInfo,  marketData,  publicDocuments[]{    _key,    title,    description,    asset->{      _id,      url,      originalFilename,      extension,      size    }  },  investNowUrl,  tradeOnMarketUrl,  _createdAt,  _updatedAt,  meta_title,  meta_description,  noindex,  ogImage {    asset->{      _id,      url,      metadata {        dimensions {          width,          height        }      }    },  }}
export type OFFERING_QUERYResult = null;
// Variable: OFFERINGS_QUERY
// Query: *[_type == "offering" && defined(slug)] | order(_createdAt desc){  companyName,  slug,  logo{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  tagline,  backgroundImage{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  industries[]->{    title,    slug,  },  valuation,  regulationType,  projectedReturns,  minimumInvestment,  geography,  status,}
export type OFFERINGS_QUERYResult = Array<never>;
// Variable: OFFERINGS_SLUGS_QUERY
// Query: *[_type == "offering" && defined(slug)]{slug}
export type OFFERINGS_SLUGS_QUERYResult = Array<never>;

// Source: ./sanity/queries/offerings-by-industry.ts
// Variable: OFFERINGS_BY_INDUSTRY_QUERY
// Query: *[_type == "offering" && defined(slug) && references($industryId)] | order(_createdAt desc){  companyName,  slug,  logo{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  tagline,  backgroundImage{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  industries[]->{    title,    slug,  },  valuation,  regulationType,  minimumInvestment,  geography,  status,}
export type OFFERINGS_BY_INDUSTRY_QUERYResult = Array<never>;

// Source: ./sanity/queries/page.ts
// Variable: PAGE_QUERY
// Query: *[_type == "page" && slug.current == $slug][0]{    blocks[]{        _type == "hero-1" => {    _type,    _key,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "hero-2" => {    _type,    _key,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "hero-3" => {    _type,    _key,    mediaType,    backgroundImage{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    backgroundVideo{        videoType,  youtubeUrl,  directUrl    },    title,    description,    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "section-header" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "split-row" => {    _type,    _key,    padding,    colorVariant,    noGap,    fullWidth,    splitColumns[]{        _type == "split-content" => {    _type,    _key,    sticky,    padding,    colorVariant,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "split-cards-list" => {    _type,    _key,    list[]{      tagLine,      title,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },    },  },        _type == "split-image" => {    _type,    _key,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },  },        _type == "split-info-list" => {    _type,    _key,    list[]{      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      title,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },      tags[],    },  },        _type == "split-offering" => {    _type,    _key,    project->{      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      }    },    showExcerpt,    showImage,    customTitle,    customExcerpt,    link{      title,      href,      target,      buttonVariant    }  },        _type == "split-project" => {    _type,    _key,    project->{      _id,      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      expiresDate,      regulationType,      budget,      categories[]->{        title,        slug      }    },    imagePosition,    showMetadata,    customTitle,    customExcerpt,    buttonText,    buttonVariant  },    },  },        _type == "grid-row" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    gridColumns,    columns[]{        _type == "grid-card" => {    _type,    _key,    title,    excerpt,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "pricing-card" => {    _type,    _key,    title,    tagLine,    price,    list[],    excerpt,    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "grid-post" => {    _type,    _key,    post->{      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      categories[]->{        _id,        title,      },    },  },    },  },        _type == "carousel-1" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    size,    orientation,    indicators,    images[]{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },  },        _type == "carousel-2" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    testimonial[]->{      _id,      name,      title,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },      rating,    },  },        _type == "carousel-gallery" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    demoUrl,    demoText,    items[]{        _type == "carousel-gallery-item" => {    _type,    _key,    title,    summary,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },    },  },        _type == "timeline-row" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    timelines[]{      title,      tagLine,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },    },  },        _type == "timeline-2" => {    _type,    _key,    padding,    colorVariant,    tagLine,    title,    description,    headerLinks[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },    phases[]{      _key,      phaseNumber,      title,      subtitle,      description,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      links[]{            _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )      },    },  },        _type == "cta-1" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "logo-cloud-1" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    images[]{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },  },        _type == "faqs" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    faqs[]->{      _id,      title,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },    },  },        _type == "form-newsletter" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    consentText,    buttonText,    successMessage,  },        _type == "all-posts" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,  },        _type == "featured-projects" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    showViewAllButton,    viewAllButtonText,    viewAllButtonVariant,    projects[]->{      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      categories[]->{        title,        slug      },    },  },        _type == "featured-offerings" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    ctaUrl,    ctaText,    offerings[]->{      _id,      companyName,      slug,      logo{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      backgroundImage{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      tagline,      projectedReturns,      minimumInvestment,      status,      valuation,    },  },        _type == "featured-industries" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    ctaUrl,    ctaText,    industries[]-> {      _id,      title,      slug,      description,      image {        ...,        asset-> {          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        },        alt      }    }  },        _type == "gallery-lightbox" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    useMasonry,    columns,    masonryColumns,    gapSize,    fullWidth,    roundedCorners,    showTagFilters,    images[]{      _key,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      caption,      tags[]->{        _id,        title,        slug,      },      hasVideo,      video{          videoType,  youtubeUrl,  directUrl      },    },  },        _type == "features-cards" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    layout,    gridColumns,    cards[]{        _type == "features-card" => {    _type,    _key,    mediaType,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    icon,    tagLine,    title,    description,    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  }    },  },        _type == "team-1" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    members[]{      _key,      name,      role,      avatar{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      socialLinks[]{          _key,  platform,  url      },    },  },        _type == "content-block" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    content[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },  },        _type == "contact-info" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    email,    phone,    officeAddress,  },        _type == "bento-box" => {    _type,    _key,    padding,    colorVariant,    tagLine,    title,    description,    cards[]{        _type == "bento-card" => {    _type,    _key,    icon,    title,    description,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    size,  },    },  },    },    meta_title,    meta_description,    noindex,    ogImage {      asset->{        _id,        url,        metadata {          dimensions {            width,            height          }        }      },    }  }
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    cards: Array<{
      _type: "bento-card";
      _key: string;
      icon: "Building2" | "Compass" | "Grid3x3" | "Home" | "Landmark" | "Target" | null;
      title: string | null;
      description: string | null;
      image: {
        asset: {
...
// Query: *[_type == "project" && slug.current == $slug][0]{    title,    subtitle,    slug,    excerpt,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    aboutTitle,    aboutText,    steps[]{      title,      content    },    buyNowUrl,    expiresDate,    regulationType,    budget,    blocks[]{        _type == "hero-1" => {    _type,    _key,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "section-header" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "split-row" => {    _type,    _key,    padding,    colorVariant,    noGap,    fullWidth,    splitColumns[]{        _type == "split-content" => {    _type,    _key,    sticky,    padding,    colorVariant,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "split-cards-list" => {    _type,    _key,    list[]{      tagLine,      title,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },    },  },        _type == "split-image" => {    _type,    _key,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },  },        _type == "split-info-list" => {    _type,    _key,    list[]{      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      title,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },      tags[],    },  },        _type == "split-offering" => {    _type,    _key,    project->{      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      }    },    showExcerpt,    showImage,    customTitle,    customExcerpt,    link{      title,      href,      target,      buttonVariant    }  },        _type == "split-project" => {    _type,    _key,    project->{      _id,      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      expiresDate,      regulationType,      budget,      categories[]->{        title,        slug      }    },    imagePosition,    showMetadata,    customTitle,    customExcerpt,    buttonText,    buttonVariant  },    },  },        _type == "grid-row" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    gridColumns,    columns[]{        _type == "grid-card" => {    _type,    _key,    title,    excerpt,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "pricing-card" => {    _type,    _key,    title,    tagLine,    price,    list[],    excerpt,    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },        _type == "grid-post" => {    _type,    _key,    post->{      title,      slug,      excerpt,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      categories[]->{        _id,        title,      },    },  },    },  },        _type == "carousel-gallery" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    demoUrl,    demoText,    items[]{        _type == "carousel-gallery-item" => {    _type,    _key,    title,    summary,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    link{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },    },  },        _type == "timeline-row" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    timelines[]{      title,      tagLine,      body[]{          ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }      },    },  },        _type == "gallery-lightbox" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    useMasonry,    columns,    masonryColumns,    gapSize,    fullWidth,    roundedCorners,    showTagFilters,    images[]{      _key,      image{          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      },      caption,      tags[]->{        _id,        title,        slug,      },      hasVideo,      video{          videoType,  youtubeUrl,  directUrl      },    },  },        _type == "cta-1" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    body[]{        ...,  markDefs[]{    ...,    _type == "link" => {          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },  _type == "image" => {      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  _type == "youtube" => {    _type,    url  }    },    links[]{          _key,    ...,    "href": select(      isExternal => href,      defined(href) && !defined(internalLink) => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "project" => "/projects/" + @.internalLink->slug.current,      @.internalLink->_type == "projects-page" => "/projects",      @.internalLink->_type == "blog-page" => "/blog",      @.internalLink->_type == "offerings-page" => "/offerings",      @.internalLink->_type == "category" => "/categories/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    },  },    },    categories[]->{      title,      slug    },    _createdAt,    _updatedAt,    meta_title,    meta_description,    noindex,    ogImage {      asset->{        _id,        url,        metadata {          dimensions {            width,            height          }        }      },    }}
...
// Query: *[_type == "projects-page"][0]{  title,  "description": subtitle,  heroImage{      ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  },  "projects": *[_type == "project" && defined(slug)] | order(_createdAt desc){    title,    slug,    excerpt,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    categories[]->{      title,      slug    },  },  meta_title,  meta_description,  noindex,  ogImage {    asset->{      _id,      url,      metadata {        dimensions {          width,          height        }      }    },  }}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"industry\" && defined(slug)] | order(orderRank){\n  title,\n  slug,\n  description,\n  image{\n    \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n  },\n}": INDUSTRIES_QUERYResult;
    "*[_type == \"industry\" && defined(slug)]{slug}": INDUSTRIES_SLUGS_QUERYResult;
    ...
    "*[_type == \"offering\" && defined(slug)] | order(_createdAt desc){\n  companyName,\n  slug,\n  logo{\n    \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n  },\n  tagline,\n  backgroundImage{\n    \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n  },\n  industries[]->{\n    title,\n    slug,\n  },\n  valuation,\n  regulationType,\n  projectedReturns,\n  minimumInvestment,\n  geography,\n  status,\n}": OFFERINGS_QUERYResult;
    "*[_type == \"offering\" && defined(slug)]{slug}": OFFERINGS_SLUGS_QUERYResult;
    "*[_type == \"offering\" && defined(slug) && references($industryId)] | order(_createdAt desc){\n  companyName,\n  slug,\n  logo{\n    \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n  },\n  tagline,\n  backgroundImage{\n    \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n\n  },\n  industries[]->{\n    title,\n    slug,\n  },\n  valuation,\n  regulationType,\n  minimumInvestment,\n  geography,\n  status,\n}": OFFERINGS_BY_INDUSTRY_QUERYResult;
