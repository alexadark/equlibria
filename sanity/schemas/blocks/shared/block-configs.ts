...
export const ALL_BLOCKS = [
  ...
  { type: 'featured-offerings' },
  { type: 'featured-industries' },
...
export const BLOCK_MENU_GROUPS = [
  ...
  { name: 'timeline', title: 'Timeline', of: ['timeline-row', 'timeline-2'] },
  ...
  { name: 'contact', title: 'Contact', of: ['contact-info'] },
  { name: 'bento', title: 'Bento', of: ['bento-box'] },
];
